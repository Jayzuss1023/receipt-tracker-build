  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="features" className="py-16 md:py-24">
        <div className="container px-4 md:p-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="flex flex-col items-center space-y-2 border border-gray-200 rounded-lg p-6 dark:border-gray-800">
                ...
                <h3 className="text-xl font-bold">AI Analyst</h3>
                <p className="text-gray-500 dark:text-gray-400 text-center">
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            {/* Free Tier */}
            <div className="flex flex-col p-6 bg-white border border-gray-200 rouned-lg shadow-sm dark:border-gray-800 dark:bg-gray-950">
              <div className="space-y-2">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-400">
